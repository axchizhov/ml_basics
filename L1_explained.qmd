...
$$ \text{Loss}+ L_1 = \frac{1}{2n} ||y - Xw||_{2}^{2} + \lambda ||w||_1 $$
...
$$ \text{Loss} + L_2 = \frac{1}{2n} ||y - Xw||_{2}^{2} + \lambda ||w||_{2}^{2} $$
...
# Попробуем реализовать своими руками

## Сгенеририруем простенький датасет
...
## Закодим градиентный спуск для L1
