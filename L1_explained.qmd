...
Тут можно углубиться в теорию оптимизаций выпуклых функций. Как вариант, с помощью метода проксимального градиента можно получить правильный алгоритм оптимизации. Но небанальные математические выкладки на самом деле приведут к весьма простомой эвристике.
